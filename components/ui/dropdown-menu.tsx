...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-soft-lg data-[state=open]:animate-scaleIn data-[state=closed]:animate-fadeOut",
      className
    )}
    {...props}
  />
